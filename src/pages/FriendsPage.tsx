...
import { ArrowLeft, Users, UserPlus, UserCheck, Clock, Check, X, Loader2 } from "lucide-react";
import { Card } from "@/components/ui/card";
import { Button } from "@/components/ui/button";
import { Avatar, AvatarFallback, AvatarImage } from "@/components/ui/avatar";
import SkillBadge from "@/components/SkillBadge";
import { useLanguage } from "@/i18n/LanguageContext";
import { useFriends, useFriendActions, type FriendEntry } from "@/hooks/useFriends";
  ...
  return (
    <div className="pb-20 min-h-screen">
      ...
      <div className="px-4 pt-3 max-w-2xl mx-auto">
        {/* Tabs */}
        <div className="grid grid-cols-3 gap-1.5 p-1 rounded-2xl bg-secondary/60 mb-4">
