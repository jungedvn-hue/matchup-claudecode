      ...
      <div className="px-4 pt-3">
        {isVerifiedReferee ? (
          <div className="flex items-center gap-2 p-2.5 rounded-lg bg-primary/10 border border-primary/30">
            ...
            <p className="text-xs font-semibold text-primary dark:text-primary">{t("referee.verifiedActive")}</p>
          </div>
        ) : refStatus === "pending" ? (
                  ...
                  >
                    <CardContent className="p-4 space-y-3">
                      ...
                      <div className="flex items-center gap-2 text-[11px]">
                        ...
                        <span className="bg-primary/10 text-primary dark:text-primary px-2 py-0.5 rounded font-medium">
