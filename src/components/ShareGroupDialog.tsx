      ...
      <DialogContent className="max-w-sm rounded-2xl">
        ...
        <div className="space-y-4 pt-1">
          ...
          <div className="flex items-center gap-2 p-2.5 rounded-xl bg-secondary/60">
            <p className="flex-1 text-[11px] font-mono text-foreground/80 truncate">{url}</p>
            <button onClick={handleCopy} className="h-7 w-7 rounded-lg bg-card flex items-center justify-center text-muted-foreground hover:text-foreground" aria-label={t("share.copyLink")}>
